  ...
  <div class="border py-3 px-6">
    <div class="grid grid-flow-col grid-cols-1">
      <div class="items-center flex">
        ...
        <span class="ml-2 hidden sm:flex font-semibold text-[#252C32]">V-Commerce</span>
      </div>

      <div class="ml-6 gap-x-3 mr-[30px]">
        <div
          class="flex md:hidden cursor-pointer select-none items-center gap-x-2 rounded-md border bg-[#4094F7] py-2 px-4 text-white hover:bg-blue-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
      ...
      <div class="ml-2 hidden md:flex lg-flex">
        <div
